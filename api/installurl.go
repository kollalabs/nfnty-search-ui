...
var configs = map[string]connectorConfig{
	"connectors/job-nimbus": {
		ConnectorInfo: connectorInfo{
			...
			MarketplaceURL: "https://jobnimbus.kolla.market/apps/wuv6u4oesbdalgoygino2k2hjm/landing",
	...
	"connectors/fluid": {
		ConnectorInfo: connectorInfo{
			...
			MarketplaceURL: "https://fluid.kolla.market/apps/xuufriqqnzgivdplio6442crwq/landing",
