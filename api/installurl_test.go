...
func TestInstallURL(t *testing.T) {
	...
	expected := "https://k-job-nimbus.us.auth0.com/authorize?audience=https%3A%2F%2Fdata.job-nimbus.program.kolla.dev&client_id=abc123&prompt=consent&redirect_uri=https%3A%2F%2Finfinitysearch.xyz%2Fapi%2Finstallcallback&response_type=code&scope=openid+offline_access+read%3Acontacts+read%3Aschedules&sub=sub_id&target=connectors%2Fjob-nimbus"
	if dst != expected {
